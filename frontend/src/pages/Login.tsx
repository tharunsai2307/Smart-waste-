...
const LoginPage: React.FC = () => {
  ...
  const handleFirebaseGoogleLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    setError('');
    try {
              ...
              {tab === 'RESIDENT' ? (
                ...
                >
                  ...
                  <div className="mt-auto pt-4">
                    <button onClick={handleFirebaseGoogleLogin} disabled={loading} className="w-full py-3 rounded-lg font-semibold text-sm tracking-widest flex items-center justify-center gap-2 transition-all bg-white text-slate-900 hover:bg-slate-100 disabled:opacity-50">
